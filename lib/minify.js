...
const { AST_Node, AST_Toplevel } = require('../lib/ast.js');
const { parse } = require('../lib/parse.js');
const { Compressor } = require('../lib/compress.js');
const { OutputStream } = require('../lib/output.js');
const { mangle_properties } = require('../lib/propmangle.js');
const { SourceMap } = require('../lib/sourcemap.js');
const { Dictionary, defaults, HOP } = require('../lib/utils.js');
